...
addSheetBtn.addEventListener('click', (e) => {
  ...
  sheet.scrollIntoView() //This show the latest values when overflowed
...
function handleSheetRemoval(sheet) {
  sheet.addEventListener('mousedown', (e) => {
    ...
    let response = confirm(
      'Your sheet will be removed permentantly, Are you sure?'
    )
    if (response === false) {
      return
    }
...
function handleSheetUIRemoval(sheet) {
  ...
  allSheetFolders[0].style.backgroundColor = '#27ae60'
}
...
function handleSheetUI(sheet) {
  ...
  sheet.style.backgroundColor = '#27ae60'
}
